...
use kernel::sched::task_finished;
...
impl Task {
    ...
    pub fn new(fun: fn (), cs: SegmentSelector, ds: SegmentSelector, int_enabled: bool) -> Task {
        let sp = unsafe {
            HEAP.alloc(::alloc::heap::Layout::from_size_align_unchecked(4096*4, 4096)).unwrap()
        };
    ...
    pub fn new_sched(fun: fn ()) -> Task {
        Task::new(fun, SegmentSelector::new(1, PrivilegeLevel::Ring0), SegmentSelector::new(0, PrivilegeLevel::Ring0), false)
    }

    pub fn new_kern(fun: fn ()) -> Task {
        Task::new(fun, SegmentSelector::new(1, PrivilegeLevel::Ring0), SegmentSelector::new(0, PrivilegeLevel::Ring0), true)
    }
